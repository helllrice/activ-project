...
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./validate */ "./src/js/validate.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validate */ "./src/js/validate.js");
...
var validate = function validate() {
  ...
  var regExpPhone = /^([+]?[0-9\s-\(\)]{3,25})*$/i;

  var setError = function setError(elem, message) {
    elem.style.border = '1px solid red';
    elem.nextElementSibling.textContent = message;
    elem.nextElementSibling.classList.add('_active');
  };

  var setSuccess = function setSuccess(elem) {
    elem.nextElementSibling.classList.remove('_active');
  };

  var resetStyling = function resetStyling(elem) {
  ...
  form.addEventListener('submit', function (e) {
    ...
    if (fieldsValidate()) {
      ...
      postData('server.php', formData).then(function (res) {
        ...
        return statusMessage.textContent = getMessage.failure;
      }).finally(function () {
        setTimeout(function () {
          closePopup();
...
/* harmony default export */ __webpack_exports__["default"] = (vk);
